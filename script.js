...
window.graphs["253"] = {
    ...
    data: [
        ...
        {
            key: "title",
            value: "K\u00e4nner sig delaktig i informationssamh\u00e4llet",
        },
    ...
    e.getElementById(o) ||
        ((window.graphtoolAPI = r + "/api"),
            ...
            $(document).ready(function () {
                $(".article").attr("x", "-20"); // Fungerar på .article men gör ingenting
                $("tspan").attr("x", "-20"); // Fungerar EJ på text eller tspan (grafens y-axel)
            
                console.log("LOADED");
            });
})(document, "script", "graphtool", "https://graphtool.internetstiftelsen.se");
